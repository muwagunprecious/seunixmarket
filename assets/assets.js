...
import clothing_tshirt from "./clothing_tshirt_real.jpg"
import clothing_jacket from "./clothing_jacket_real.jpg"
import clothing_hoodie from "./clothing_hoodie_real.jpg"
import clothing_sneakers from "./clothing_sneakers_real.jpg"
import clothing_dress from "./clothing_dress_real.jpg"
import clothing_pants from "./clothing_jeans_real.jpg"
import clothing_bag from "./clothing_bag_real.jpg"
import clothing_watch from "./clothing_watch_real.jpg"
...
export const assets = {
    ...
    clothing_tshirt, clothing_jacket, clothing_hoodie, clothing_sneakers, clothing_dress, clothing_pants, clothing_bag, clothing_watch
}

export const categories = ["Clothing", "Jackets", "Hoodies", "Footwear", "Accessories", "Watches"];
...
export const productDummyData = [
    {
        ...
        description: "Premium 100% organic cotton t-shirt with a comfortable regular fit. Breathable fabric designed for all-day comfort and casual wear.",
        mrp: 45,
        price: 29,
        images: [clothing_tshirt, clothing_jacket, clothing_hoodie, clothing_sneakers],
        category: "Clothing",
        storeId: "seller_1",
        inStock: true,
    ...
    {
        id: "prod_2",
        name: "Urban Zip-Up Jacket",
        description: "Stylish weather-resistant urban jacket featuring a dual zipper, side slit pockets, and lightweight thermal lining.",
        mrp: 120,
        price: 85,
        images: [clothing_jacket],
        storeId: "seller_1",
        inStock: true,
        store: dummyStoreData,
        category: "Jackets",
    ...
    },
    {
        ...
        description: "Cozy fleece-lined hoodie with kangaroo front pocket and adjustable drawstring hood. Perfect for street style and relaxed lounging.",
        mrp: 80,
        price: 55,
        images: [clothing_hoodie],
        storeId: "seller_1",
        inStock: true,
        store: dummyStoreData,
        category: "Hoodies",
    ...
    },
    {
        ...
        description: "Lightweight breathable mesh sneakers engineered with shock-absorbing soles for superior grip, comfort, and performance.",
        mrp: 150,
        price: 99,
        images: [clothing_sneakers],
        storeId: "seller_1",
        inStock: true,
        store: dummyStoreData,
        category: "Footwear",
    ...
    },
    {
        ...
        description: "A striking evening gown crafted from soft stretch crepe with a cinched waistline and flared skirt detail.",
        mrp: 180,
        price: 135,
        images: [clothing_dress],
        storeId: "seller_1",
        inStock: true,
        store: dummyStoreData,
        category: "Clothing",
    ...
    },
    {
        ...
        description: "Classic 5-pocket denim jeans with modern slim fit cut and durable reinforced stitching for long-lasting wear.",
        mrp: 90,
        price: 65,
        images: [clothing_pants],
        storeId: "seller_1",
        inStock: true,
        store: dummyStoreData,
        category: "Clothing",
    ...
    },
    {
        ...
        description: "Handcrafted genuine leather tote bag featuring spacious compartments, magnetic clasp, and interior zippered security pocket.",
        mrp: 140,
        price: 110,
        images: [clothing_bag],
        storeId: "seller_1",
    ...
    {
        id: "prod_8",
        name: "Casual Streetwear T-Shirt",
        description: "Heavyweight streetwear graphic t-shirt with reinforced crew neck collar and pre-shrunk cotton fabric.",
        mrp: 50,
        price: 35,
        images: [clothing_tshirt],
        storeId: "seller_1",
        inStock: true,
        store: dummyStoreData,
        category: "Clothing",
    ...
    {
        id: "prod_9",
        name: "Windbreaker Outdoor Jacket",
        description: "Water-repellent windbreaker jacket equipped with elastic cuffs and a storm hood for outdoor protection.",
        mrp: 130,
        price: 95,
        images: [clothing_jacket],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Sleek minimalist analog wristwatch with genuine leather strap, scratch-resistant mineral glass, and Japanese quartz movement.",
        mrp: 175,
        price: 120,
        images: [clothing_watch],
        storeId: "seller_1",
        inStock: true,
        store: dummyStoreData,
        category: "Watches",
    ...
    },
    {
        ...
        description: "Iconic high-top canvas sneakers featuring padded ankle collar, vulcanized rubber sole, and retro laces.",
        mrp: 95,
        price: 70,
        images: [clothing_sneakers],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Soft cotton blend pullover hoodie with double-layer hood construction and ribbed wrist cuffs.",
        mrp: 85,
        price: 60,
        images: [clothing_hoodie],
        storeId: "seller_1",
